...
- **District_Revenues_FY20-FY24_FILTERED.pdf** (Derived / NOT client-provided)
  - **Covers**: FY2020–FY2024 (filtered/cleaned version)
  - **Content**: A processed PDF generated during the extraction workflow (contains cleaned tables or combined pages)
  - **Generated by**: PDF extraction scripts in `PDF_Extraction/District_Revenues_FY20_FY24.ipynb`
  - **Note**: This file is produced by our extraction process for convenience and auditing; it is not an original MuckRock-provided document.
